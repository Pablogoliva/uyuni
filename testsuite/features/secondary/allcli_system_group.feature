...
Feature: Manage a group of systems
  ...
  Scenario: Pre-require: enable old packages to fake a possible installation and check that were created
  ...
  Scenario: Check that a patche can be applied
    When I follow the left menu "Systems > System Groups"
    And I follow "new-systems-group"
  ...
  Scenario: Check that a patche can be applied in a SSM
 ...
 Scenario: Check that a package can be installed
    When I follow the left menu "Systems > System Set Manager > Overview"
    ...
    And I click on the filter button
    When I check the "andromeda-dummy-2.0-1.1" client
 ...
 Scenario: Check that a package can be deleted
    When I follow the left menu "Systems > System Set Manager > Overview"
    And I follow "Packages"
    And I follow "Remove"
    And I enter "virgo-dummy" as the filtered package name
    And I click on the filter button
    And I check the "virgo-dummy-1.0-1.2" client
